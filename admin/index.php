...
if(isset($_POST['publier'])){
    ...
    $sql = "INSERT INTO `posts` (`id`, `date`, `titre`, `contenu`) VALUES ('', '$dt', '$title', '$contenu');";
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
            ...
            <h4 class="text-center ">Créer une nouvelle publication</h4>
            <div class="row justify-content-center" id="row_style">
                <form action="index.php" method="post">
                    ...
                    <textarea id="editor" cols="30" rows="10" name="contenu">Votre texte ici...</textarea>
                    <br>
                    <!--            <div class="form-group">-->
                    <!--                <input type="text" class="form-control" placeholder="Tags">-->
                    <!--            </div>-->
                    <div class="form-group">
                        <button class="btn btn-primary" id="submit" name="publier">Publier</button>
                    </div>
